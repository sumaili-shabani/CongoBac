	...
	function recuperaion_password(){
        ...
        if($this->form_validation->run())
        {
            ...
            if($result == '')
            {
                ...
                $subject = "votre mot de passe de recupération au compte system congoback";
                $message2 = "
                <p>Salut!!! voici votre code de recupération de votre mot de passe au système de congoback ".$verification_key." cliquer sur ce lien pour changer votre nouveau mot de passe <a href='".base_url()."login/change_secure/".$verification_key."'>changer mon mot de passe</a>.</p>
