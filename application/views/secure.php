...
<div class="auth-main particles_js">
    <div class="auth_div vivify popIn">
        ...
        <div class="card forgot-pass">
            <div class="body">
                <p class="lead mb-3"><strong>Ouf!!!</strong><br>  recover your password now</p>
                <p>You are only one step a way from your new password, recover your password now.</p>
                <form class="form-auth-small" method="post" action="<?php echo base_url(); ?>login/recupere_passe_word">
                    ...
                    <div class="form-group">                                    
                        <input type="password" class="form-control round" name="user_password" id="password" value="<?php echo set_value('user_password'); ?>" placeholder="new password">
                        <span class="text-danger"><?php echo form_error('user_password'); ?></span>
                    </div>

                    <div class="form-group">                                    
                        <input type="password" class="form-control round" name="user_password2" id="password2" value="<?php echo set_value('user_password2'); ?>" placeholder="Confirm your new password">
