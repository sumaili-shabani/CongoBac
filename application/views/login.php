    ...
    <div class="auth_div vivify popIn">
        ...
        <div class="card">
            <div class="body">
                ...
                <form class="form-auth-small m-t-20"  method="post" action="<?php echo base_url(); ?>login/validation">
                    ...
                    <div class="form-group">
                        <label for="user_email" class="control-label sr-only">Email</label>
                        <input type="email" name="user_email" class="form-control round" id="signin-email" placeholder="user@domain.com" value="<?php echo set_value('user_email'); ?>">
                        <span class="text-danger"><?php echo form_error('user_email'); ?></span>
                    </div>
                    <div class="form-group">
                        <label for="signin-password" class="control-label sr-only">Password</label>
                        <input name="user_password" type="password" class="form-control round" placeholder="Mot de passe" value="<?php echo set_value('user_password'); ?>">
                    ...
                    <div class="bottom">
                        <span class="helper-text m-b-10"><i class="fa fa-lock"></i> <a href="<?php echo(base_url()) ?>login/recupere_secure">Forgot password?</a></span>
