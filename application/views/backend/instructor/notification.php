                                   ...
                                   <div class="col-lg-3 col-md-6">
			                            <div class="card c_grid c_yellow">
			                                <div class="body text-center">
			                                    ...
			                                    <h6 class="mt-3 mb-0"><span class="text-info"><?php echo($not['titre']) ?></span><?php echo($not['message']) ?> </h6>

			                                    
			                                    <a href="<?php echo(base_url()) ?><?php echo($not['url']) ?>" class="btn btn-default btn-sm"><i class="fa fa-slack"></i>voir</a>

			                                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce cours dans la liste favorie?')" href="<?php echo(base_url()) ?>instructor/view/display_delete/<?php echo($not['id']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> supprimer</a>
			                                </div>
			                            </div>
			                        </div>
