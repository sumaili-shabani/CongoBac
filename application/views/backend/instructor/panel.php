			                ...
			                <div class="col-xl-8 col-lg-8 col-md-7">
			                    <div class="card">
			                        ...
			                        <div class="body">
			                            <div class="row clearfix">
			                            	<!-- form commence -->
			                            	<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>instructor/modification_panel/option1/<?php echo($id) ?>">
			                            	<div class="col-lg-12">
			                            		<div class="row">
			                    ...
			                    <div class="card">
			                        ...
			                        <div class="body">
			                            <div class="row clearfix">
			                            	...
			                            	<div class="col-md-12">
												<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>instructor/modification_photo/<?php echo($id) ?>">
	                        ...
	                        <div class="body">
	                            <div class="row clearfix">
	                                ...
	                                <div class="col-lg-12 col-md-12">
	                                    ...
	                                    <form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>instructor/modification_account2/<?php echo($id) ?>">
	                                    <div class="col-md-12">
                                    		<div class="text-center" align="center">
								        		<?php
									            if($this->session->flashdata('message'))
