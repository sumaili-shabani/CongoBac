...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
           ...
           if(noml != '' && descriptionl !='' && auteur !='' && edition !='' && iddep !='')
            {
	            ...
	            if (action =="Add") {
	                ...
	                $.ajax({  
	                     url:"<?php echo base_url() . 'instructor/operation_pendingbook/Add'?>",  
	                     method:'POST',  
		        	...
		        	$.ajax({  
                         url:"<?php echo base_url() . 'instructor/modification_pendingbook'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
      ...
      $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url(); ?>instructor/fetch_single_pendingbook",  
                method:"POST",  
                data:{idl:idl},  
                dataType:"json",  
                success:function(data)  
          ...
          var idl = $(this).attr("idl");
          	...
          	swal({
		        ...
		        if (isConfirm) {
		        	...
		        	$.ajax({
		              url:"<?php echo base_url(); ?>instructor/suppression_pendingbook",
		              method:"POST",
		              data:{idl:idl},
		              success:function(data)
		              {
    ...
    $(document).on('change', '#id_province', function(){
		  ...
		  if(country_id != '')
		  {
			  // alert(country_id);
			   $.ajax({
				    url:"<?php echo base_url(); ?>instructor/fetch_ville_requete",
				    method:"POST",
				    data:{idp:country_id},
				    success:function(data)
				    {
    ...
    $(document).on('change', '#id_ville', function(){
		  ...
		  if(idv != '')
		  {
			  // alert(idv);
			   $.ajax({
				    url:"<?php echo base_url(); ?>instructor/fetch_university_requete",
				    method:"POST",
				    data:{idv:idv},
				    success:function(data)
				    {
    ...
    $(document).on('change', '#id_universite', function(){
		  ...
		  if(iduniv != '')
		  {
			  // alert(iduniv);
			   $.ajax({
				    url:"<?php echo base_url(); ?>instructor/fetch_university_faculte",
				    method:"POST",
				    data:{iduniv:iduniv},
				    success:function(data)
				    {
    ...
    $(document).on('change', '#id_faculte', function(){
		  ...
		  if(idfac != '')
		  {
			  // alert(idfac);
			   $.ajax({
				    url:"<?php echo base_url(); ?>instructor/fetch_university_departement",
				    method:"POST",
				    data:{idfac:idfac},
				    success:function(data)
				    {
		  ...
		  if(checkbox.length > 0)
		  {
			   ...
			   swal({
			        ...
			        if (isConfirm) {
					   ...
					   $.ajax({
					    url:"<?php echo base_url(); ?>instructor/accepte_verification_livre",
					    method:"POST",
	  ...
	  if(checkbox.length > 0)
	  {
		   ...
		   swal({
		        ...
		        if (isConfirm) {
		        	// alert(checkbox_value);
				   $.ajax({
				    url:"<?php echo base_url(); ?>instructor/verification_livre_delete",
				    method:"POST",
				    data:{checkbox_value:checkbox_value},
				    success:function(data)
				    {
