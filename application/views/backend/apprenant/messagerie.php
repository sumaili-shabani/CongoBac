                        ...
                        <div class="body">
                          ...
                          <?php
                                ...
                                <div class="chat-message clearfix">
                                	<form action="<?php echo(base_url()) ?>student/chat_local_view/<?php echo($id) ?>/<?php echo($id_recever2) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="chatapp_detail text-center vivify pullLeft delay-150">
                                ...
                                <a href="<?php echo(base_url()) ?>student/detail_users_profile/<?php echo($id_user_chat) ?>" class="btn btn-round btn-success">Voir son profile</a>
                            </div>
                            <!-- fin détail user -->
                        </div>
                    </div>
...
<script type="text/javascript">
  $(document).ready(function(){
      $(document).on('keyup', '.rechercher_un_utilisateur2', function(){
        ...
        $.ajax({
          url:"<?php echo(base_url()) ?>student/recherche_utilisateur_chat",
          method: 'POST',
          data: {
            query: query
          },
