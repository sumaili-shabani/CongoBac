        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                        <li><a href="<?php echo(base_url()) ?>student"><i class="icon-user"></i>Mon Profile</a></li>
                        <li><a href="<?php echo(base_url()) ?>student/message/<?php echo($id) ?>"><i class="icon-envelope-open"></i>Messages</a></li>
                        <li><a href="<?php echo(base_url()) ?>student/detail_book_livre"><i class="icon-book-open"></i>Bibliothèque</a></li>
                        <li class="divider"></li>
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="<?= base_url() ?>student/calendrier"><i class="icon-calendar"></i><span>Calendrier</span></a></li> 

                     <li><a href="<?= base_url() ?>student/map"><i class="icon-map"></i><span>Communauté Map</span></a></li>  
                    ...
                    <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="<?= base_url() ?>student/view_formation">
                                Liste formation
                            </a>
                          </li>

                          <li>
                            <a href="<?= base_url() ?>student/news_app">
                                Les nouvelles
                            </a>
                          </li>
                    ...
                    <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="<?php echo(base_url()) ?>student/groupe">
                              Groupe de discution
                            </a>
                          </li>
