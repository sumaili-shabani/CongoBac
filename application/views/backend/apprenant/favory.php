                                ...
                                <div class="col-lg-3 col-md-6">
		                            <div class="card c_grid c_yellow">
		                                <div class="body text-center">
		                                    ...
		                                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce cours dans la liste favorie?')" href="<?php echo(base_url()) ?>student/view/display_delete_favory_cours/<?php echo($id) ?>/<?php echo($not4['idfav']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> supprimer</a>
		                                </div>
		                            </div>
		                        </div>
