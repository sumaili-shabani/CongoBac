...
<div id="wrapper">
                        ...
                        <div class="profile-header d-flex justify-content-between justify-content-center">
                            ...
                            <div>
                                ...
                                if ($id !== $users_id) {
                                	...
                                	<a href="<?php echo(base_url()) ?>student/chat_admin/<?php echo($id) ?>/<?php echo($id_user) ?>" class="btn btn-success btn-sm">Message<a>
                                	<?php
                                	# code...
                                }
                                else{
    ...
    <input type="hidden" class="connected_user" name="connected_user" id="connected_user" value="<?php echo($this->session->userdata('id')) ?>" >
