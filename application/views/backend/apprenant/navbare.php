                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu right_chat email vivify fadeIn">
                            <li class="header green"><a href="<?php echo(base_url()) ?>student/message/<?php echo($id) ?>" class="text-white">Vous avez <?php echo($nombre_de_message) ?> messages</a></li>
                             ...
                             if ($message->num_rows() > 0) {
                              ...
                              foreach ($message->result_array() as $not5) {
                                ...
                                <li>
                                    <a href="<?php echo(base_url()) ?>student/chat_admin/<?php echo($id) ?>/<?php echo($not5['id_user']) ?>">
                                        <div class="media">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu feeds_widget vivify fadeIn">
                            <li class="header blue"><a href="<?php echo(base_url()) ?>student/notification/<?php echo($id) ?>" class="text-white">Vous avez <?php echo($nombre_de_notification) ?> notifications</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu right_chat email vivify fadeIn">
                            <li class="header bg-warning"><a href="<?php echo(base_url()) ?>student/favory/<?php echo($id) ?>" class="text-white">Vous avez <?php echo($nombre_de_favory3) ?> cours dans le favori</a></li>
                    ...
                    <li class="p_social"><a href="<?php echo(base_url()) ?>student/news_app" class="social icon-menu" title="News">Information</a></li>
                    <li class="p_news"><a href="<?php echo(base_url()) ?>student/view_formation" class="news icon-menu" title="News">Les formations</a></li>
                            ...
                            <ul class="chat-widget clearfix">
                                ...
                                if ($users_chat->num_rows() > 0) {
                                    ...
                                    <div class="input-group p-t-15">
                                        ...
                                        <form action="<?php echo(base_url()) ?>student/chat_local_view/<?php echo($id) ?>/<?php echo($id_recever) ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        if ($online->num_rows() > 0) {
                                          ?>
                                            ...
                                            foreach ($online->result_array() as $key) {
                                               ...
                                               <li class="online">
                                                    <a href="<?php echo(base_url()) ?>student/detail_users_profile/<?php echo($key['id_user']) ?>">
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body" style="padding-right: 10px;">
                                                                ...
                                                                if ($key['id_user'] != $id) {
                                                                    ?>
                                                                    <span class="message">
                                                                        <a href="<?php echo(base_url()) ?>student/chat_admin/<?php echo($id) ?>/<?php echo($key['id_user']) ?>">
                                                                    ...
                                                                    ?>
                                                                    <span class="message">
                                                                        <a href="<?php echo(base_url()) ?>student/detail_users_profile/<?php echo($key['id_user']) ?>" class="text-warning">
                    ...
                    <ul class="right_chat list-unstyled mb-0">
                        ...
                        if ($groups->num_rows() > 0) {
                            foreach ($groups->result_array() as $key) {
                               ?>
                               <li class="offline">
                                    <a href="<?php echo(base_url()) ?>student/chat_admin2/<?php echo($id) ?>/<?php echo($key['code']) ?>">
                                        <div class="media">
