...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>student/pagination_access_livre/"+page,
   method:"GET",
   dataType:"json",
	...
	$(document).ready(function(){
		$(document).on('click','.favory_cours', function(e){
		 	...
		 	if (id_user=='') {
		 		...
		 		$.ajax({
		 			url:"<?php echo base_url(); ?>student/operation_ajout_favory_livre",
		 			method: 'POST',
		 			data:{
		 				id_user: id_user,
		 				idl: idl
		...
		$(document).on('click','.like_cours', function(e){
		 	...
		 	if (id_user=='') {
		 		...
		 		$.ajax({
		 			url:"<?php echo base_url(); ?>student/operation_ajout_like_livre",
		 			method: 'POST',
		 			data:{
		 				id_user: id_user,
		 				idl: idl
		...
		{
		  $.ajax({
		   url:"<?php echo base_url(); ?>student/fetch_search_livre_book",
		   method:"POST",
		   data:{query:query},
		   success:function(data){
