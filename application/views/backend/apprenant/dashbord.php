...
<div id="wrapper">
                ...
                <div class="col-md-12">
                    <div class="card social">
                        <div class="profile-header d-flex justify-content-between justify-content-center">
                            ...
                            <div>
                               <!--  <a class="btn btn-primary btn-sm Follow_User" id_recever="<?php echo($id) ?>">Follow</a>
                                <?php 
                                if ($id !== $id_user) {
                                	?>
                                	
                                	<a href="<?php echo(base_url()) ?>admin/chat_admin/<?php echo($id) ?>/<?php echo($id_user) ?>" class="btn btn-success btn-sm">Message<a>
                                	<?php
                                	# code...
                                }
                                else{
                        ...
                        <ul class="nav nav-tabs3 mt-2">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Feed">Statut</a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Activity">Sécurité</a></li>
			                ...
			                <div class="col-xl-8 col-lg-8 col-md-7">
			                    <div class="card">
			                        ...
			                        <div class="body">
			                            <div class="row clearfix">
			                            	<!-- form commence -->
			                            	<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>student/modification_panel/option1/<?php echo($id) ?>">
			                            	<div class="col-lg-12">
			                            		<div class="row">
											        ...
											        <div class="col-md-6">
											        	...
											        	<input type="text" name="university" id="university" class="form-control" value="<?php echo($university) ?>" >
											           <div class="col-md-12">
											        ...
											        <div class="col-md-6">
											        	...
											        	<input type="text" name="faculte" id="faculte" class="form-control" value="<?php echo($faculte) ?>" >
											           <div class="col-md-12">
											        ...
											        <div class="col-md-6">
											        	...
											        	<input type="text" name="option" id="option" class="form-control" value="<?php echo($option) ?>" >
											           <div class="col-md-12">
											        ...
											        <div class="col-md-12">
											        	<label class="label-control"><i class="fa fa-phone"></i>Complèter votre biographie</label>
											        	 ...
											        	 <textarea name="biographie" class=" form-control" placeholder="Quelle est ta biographie préferée?"
                                                          >
                                                          	<?php echo($biographie) ?>
                                                          </textarea>
											           <div class="col-md-12">
			                    ...
			                    <div class="card">
			                        ...
			                        <div class="body">
			                            <div class="row clearfix">
			                            	...
			                            	<div class="col-md-12">
												<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>student/modification_photo/<?php echo($id) ?>">
										        	...
										        	<div class="row">
										        		...
										        		<div class="col-md-3">
										        			<label class="label-control text-white">sauvegarder</label>
										        			
										        			<input type="hidden" name="id" id="operation" value="<?php echo($id) ?>" />

											        		<input type="submit" name="action" id="action" class="btn btn-primary btn-round pull-right" value="modifier la photo" />
										        		</div>
										        	</div>
	                        ...
	                        <div class="body">
	                            <div class="row clearfix">
	                                ...
	                                <div class="col-lg-12 col-md-12">
	                                    ...
	                                    <form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>student/modification_account/<?php echo($id) ?>">
	                                    <div class="col-md-12">
                                    		<div class="text-center" align="center">
								        		<?php
									            if($this->session->flashdata('message'))
	                                ...
	                                <div class="col-lg-12 col-md-12">
	                                    ...
	                                    <div class="table-responsive">
				                            <table class="table table-hover table-custom spacing5 user_table">
				                                ...
				                                <tbody>
				                                	<?php 
				                                	$follower = $this->db->query("SELECT users.id,users.biographie, users.first_name,users.last_name,users.image,users.telephone,users.email FROM users INNER JOIN follower ON follower.id_sender= users.id WHERE follower.id_recever='".$id."' GROUP BY follower.id_sender ORDER BY follower.created_at DESC ");
				                                	if ($follower->num_rows() > 0) {
				                                		foreach ($follower->result_array() as $key) {
				                                			...
				                                			<tr>
						                                        ...
						                                        <td>
						                                            <a href="<?php echo(base_url()) ?>student/detail_users_profile/<?php echo($key['id']) ?>" title=""><?php echo($key['first_name']) ?></a>
						                                        ...
						                                        <td>
						                                            ...
						                                            <a href="<?php echo(base_url()) ?>student/chat_admin/<?php echo($id) ?>/<?php echo($key['id']) ?>" class="btn btn-success btn-sm">Message<a>
                        	...
                        	<div class="card-body">
                        		...
                        		<div class="table-responsive">
		                            <table class="table table-hover table-custom spacing5 user_table">
		                                ...
		                                <tbody>
		                                	<?php 
		                                	$follower = $this->db->query("SELECT users.id, users.first_name,users.biographie ,users.last_name,users.image,users.telephone,users.email FROM users INNER JOIN follower ON follower.id_recever= users.id WHERE follower.id_sender='".$id."' GROUP BY follower.id_recever ORDER BY follower.created_at DESC ");
		                                	if ($follower->num_rows() > 0) {
		                                		foreach ($follower->result_array() as $key) {
		                                			?>
		                                			<tr>
    ...
    <input type="hidden" class="connected_user" name="connected_user" id="connected_user" value="<?php echo($id) ?>" >
	...
	$(document).ready(function(){
		$(document).on('click','.Follow_User', function(e){
		 	...
		 	if (id_sender==id_recever) {
		 		...
		 		$.ajax({
		 			url:"<?php echo base_url(); ?>student/operation_follower",
		 			method: 'POST',
		 			data:{
		 				id_sender: id_sender,
