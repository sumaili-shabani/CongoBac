                                ...
                                <div class="col-lg-3 col-md-6">
		                            <div class="card c_grid c_yellow">
		                                <div class="body text-center">
		                                    ...
		                                    <a href="<?php echo(base_url()) ?>student/chat_admin/<?php echo($id) ?>/<?php echo($not['id_user']) ?>" class="btn btn-default btn-sm"><i class="fa fa-comment-o"></i>chat</a>

		                                    <a onclick="return confirm('Etes-vous sûre de vouloire Supprimer ce message?')" href="<?php echo(base_url()) ?>student/view/display_delete_message/<?php echo($id) ?>/<?php echo($not['idmessage']) ?>" class="btn btn-default btn-sm"><i class="fa fa-trash"></i> supprimer</a>
		                                </div>
		                            </div>
		                        </div>
