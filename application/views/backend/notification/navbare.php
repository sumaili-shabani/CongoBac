                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu right_chat email vivify fadeIn">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="<?= base_url('js/assets/images/xs/avatar5.jpg')?>" alt="">
                                        <div class="media-body">
                            ...
                            <li>
                                <a href="javascript:void(0);">
                                    <div class="media mb-0">
                                        <img class="media-object " src="<?= base_url('js/assets/images/xs/avatar2.jpg')?>" alt="">
                                        <div class="media-body">
            ...
            <table class="table table-hover table-custom spacing5">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= base_url('js/assets/images/xs/avatar2.jpg')?>" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                <div class="ml-3">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= base_url('js/assets/images/xs/avatar5.jpg')?>" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                <div class="ml-3">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="<?= base_url('js/assets/images/xs/avatar6.jpg')?>" data-toggle="tooltip" data-placement="top" title="" alt="Avatar" class="w35 h35 rounded" data-original-title="Avatar Name">
                                <div class="ml-3">
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="<?= base_url('js/assets/images/image-gallery/7.jpg')?>" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?= base_url('js/assets/images/image-gallery/8.jpg')?>" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="<?= base_url('js/assets/images/image-gallery/9.jpg')?>" alt="Third slide">
                                </div>
                            </div>
                    ...
                    <div class="slim_scroll">
                        <div class="chat_detail">
                            <ul class="chat-widget clearfix">
                                ...
                                <li class="right">
                                    <img src="<?= base_url('js/assets/images/xs/avatar1.jpg')?>" class="rounded" alt="">
                                    <div class="chat-info">
