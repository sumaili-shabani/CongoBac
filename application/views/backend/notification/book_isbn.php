        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="form-group">
                              <div id="viewerCanvas" style="width: 100%; height: 450px;"></div>
                            </div>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-8 col-sm-12">
                	...
                	<input type="hidden" name="bookIsbn" class="bookIsbn"  value="<?php echo($bookIsbn) ?>">
 ...
 $(document).ready(function(){
   google.books.load();
    ...
    function initialize() {
      ...
      var bookIsbn_link = $('.bookIsbn').val();
      // alert(bookIsbn_link);
      var bookisbn = bookIsbn_link;
      viewer.load('ISBN:'+bookIsbn_link);
    }
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"<?php echo base_url(); ?>admin/pagination_access_livre/"+page,
   method:"GET",
   dataType:"json",
	...
	$(document).ready(function(){
		$(document).on('click','.favory_cours', function(e){
		 	...
		 	if (id_user=='') {
		 		...
		 		$.ajax({
		 			url:"<?php echo base_url(); ?>admin/operation_ajout_favory_livre",
		 			method: 'POST',
		 			data:{
		 				id_user: id_user,
		 				idl: idl
		...
		$(document).on('click','.like_cours', function(e){
		 	...
		 	if (id_user=='') {
		 		...
		 		$.ajax({
		 			url:"<?php echo base_url(); ?>admin/operation_ajout_like_livre",
		 			method: 'POST',
		 			data:{
		 				id_user: id_user,
		 				idl: idl
		...
		{
		  $.ajax({
		   url:"<?php echo base_url(); ?>admin/fetch_search_livre_book",
		   method:"POST",
		   data:{query:query},
		   success:function(data){
