                             ...
                             <div class="card">
                                    ...
                                    <div class="card-footer">
                                      ...
                                      if($this->session->userdata('id')) {
                                        ...
                                        ?>
                                        <a href="<?php echo(base_url()) ?>student/likes/add_like/<?php echo($value['idinfo']) ?>" class="mr-3"><i class="icon-like"></i> <?php echo($nbr) ?> Likes </a>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 reponse">
                                              <div class="row">
                                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" style="margin-top: 5px;" >
                                                  <form method="POST" action="<?php echo(base_url()) ?>student/commentaire/add_comment/<?php echo($value['idinfo']) ?>">
                                      ...
                                      elseif($this->session->userdata('admin_login')) {
                                        ...
                                        ?>
                                        <a href="<?php echo(base_url()) ?>admin/likes/add_like/<?php echo($value['idinfo']) ?>" class="mr-3"><i class="icon-like"></i> <?php echo($nbr) ?> Likes </a>
                                        <div class="pull-right">
                                          <a href="javascript:void(0);" class="mr-3 affichier"><i class="icon-bubbles"></i> <?php echo($nbr_comment) ?> Comments </a>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 reponse">
                                              <div class="row">
                                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12" style="margin-top: 5px;" >
                                                  <form method="POST" action="<?php echo(base_url()) ?>admin/commentaire/add_comment/<?php echo($value['idinfo']) ?>">
                                                    <div class="form-group">
                                                      <textarea class="form-control" name="message" id="comment" placeholder="Quoi de news?" style="overflow:hidden" class="form-control" rows="2" cols="4">
