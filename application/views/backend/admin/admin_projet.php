		                      ...
		                      <table id="user_data" class="table table-hover table-custom spacing5 ">  
		                       <thead>
                                  <tr>
                                    ...
                                    <th width="35%">titre du projet</th>
                                    <th width="35%">message du projet</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="from-group">
            <label><i class="fa fa-globe"></i>Entrer le titre du projet</label>
            <input type="text" name="titre" id="titre" class="form-control" />
          
          </div>
          
          <div class="from-group">
            <label><i class="fa fa-book"></i>Entrer le message du projet</label>
...
<script type="text/javascript" language="javascript" >  
 $(document).ready(function(){  
      ...
      var dataTable = $('#user_data').DataTable({  
           ...
           "order":[],  
           "ajax":{  
                url:"<?php echo base_url() . 'admin/fetch_projet'; ?>",  
                type:"POST"  
           },  
           "columnDefs":[  
                {  
           ...
           if(titre != '' && message != '')
            {
              ...
              if (action =="Add") {
                  ...
                  $.ajax({  
                       url:"<?php echo base_url() . 'admin/operation_projet'?>",  
                       method:'POST',  
              ...
              if (action == 'Edit') {
                  ...
                  if (extension =='') {
                    ...
                    $.ajax({  
                         url:"<?php echo base_url() . 'admin/modification_projet2'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
                    ...
                    $.ajax({  
                         url:"<?php echo base_url() . 'admin/modification_projet'?>",  
                         method:'POST',  
                         data:new FormData(this),  
                         contentType:false,  
                         processData:false,  
      ...
      $(document).on('click', '.update', function(){  
           ...
           $.ajax({  
                url:"<?php echo base_url(); ?>admin/fetch_single_projet",  
                method:"POST",  
                ...
                {  
                     ...
                     $('.modal-title').text("modification d'un projet");  
      ...
      $(document).on('click', '.delete', function(){
          ...
          if(confirm("Are you sure you want to delete this?"))
          {
            ...
            $.ajax({
              url:"<?php echo base_url(); ?>admin/supression_projet",
              method:"POST",
              data:{idprojet:idprojet},
              success:function(data)
              {
