                                    	...
                                    	if ($gr->num_rows() > 0) {
                                			...
                                			<li class="clearfix">
	                                            ...
	                                            <div class="md-right">
	                                                ...
	                                                <p class="sub"><a href="<?php echo(base_url()) ?>admin/chat_admin/<?php echo($id) ?>/<?php echo($key['id']) ?>" class="mail-detail-expand"><?php echo($key['first_name']) ?> <?php echo($key['last_name']) ?></a></p>
