                ...
                <div class="col-lg-12">                    
                    <div class="card">
                        ...
                        $status_msg = '';
                            ...
                            $voir_plus = base_url().'admin/detail_users_profile/'.$data['id'];
					            			?>
                                ...
                                <div class="chat-message clearfix">
                                	<form action="<?php echo(base_url()) ?>admin/chat_local_view_groupe/<?php echo($id) ?>/<?php echo($code_groupe) ?>" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
  $(document).ready(function(){
      $(document).on('keyup', '.rechercher_un_utilisateur2', function(){
        ...
        $.ajax({
          url:"<?php echo(base_url()) ?>admin/recherche_utilisateur_chat_goupe",
          method: 'POST',
          data: {
            query: query,
