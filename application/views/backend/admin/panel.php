			                    ...
			                    <div class="card">
			                        ...
			                        <div class="body">
			                            <div class="row clearfix">
			                            	...
			                            	<div class="col-md-12">
												<form method="post" id="user_form" enctype="multipart/form-data" action="<?= base_url(); ?>admin/modification_photo/<?php echo($id) ?>">
				                                		...
				                                		foreach ($follower->result_array() as $key) {
				                                			...
				                                			<tr>
						                                        ...
						                                        <td>
						                                            ...
						                                            <a href="<?php echo(base_url()) ?>admin/chat_admin/<?php echo($id) ?>/<?php echo($key['id']) ?>" class="btn btn-success btn-sm">Message<a>
