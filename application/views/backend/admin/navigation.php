        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right account vivify flipInY">
                        <li><a href="<?php echo(base_url()) ?>admin"><i class="icon-user"></i>Mon Profile</a></li>
                        <li><a href="<?php echo(base_url()) ?>admin/message/<?php echo($id) ?>"><i class="icon-envelope-open"></i>Messages</a></li>
                        <li><a href="<?php echo(base_url()) ?>admin/detail_book_livre"><i class="icon-book-open"></i>Bibliothèque</a></li>
                        <li class="divider"></li>
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li><a href="<?= base_url() ?>admin/calendrier"><i class="icon-calendar"></i><span>Calendrier</span></a></li> 

                     <li><a href="<?= base_url() ?>admin/map"><i class="icon-map"></i><span>Communauté Map</span></a></li>  


                    <li class="header">UI Elements</li>
                    <li>
                        <a href="#uiIcons" class="has-arrow"><i class="icon-tag"></i><span>University</span></a>
                        <ul>
                            <li><a href="<?php echo(base_url()) ?>admin/province">Province</a></li>
                            <li><a href="<?php echo(base_url()) ?>admin/ville">Ville et chef lieu</a></li>
                            <li><a href="<?php echo(base_url()) ?>admin/university">Université</a></li>
                            <li><a href="<?php echo(base_url()) ?>admin/faculty">Faculté</a></li>
                            <li><a href="<?php echo(base_url()) ?>admin/departement">Département</a></li>
                     ...
                     <li>
                        ...
                        <ul>
                            <li><a href="<?php echo(base_url()) ?>admin/livre_book">Livres</a></li>
                            <li><a href="<?php echo(base_url()) ?>admin/pending_livre_book">Pending Livres</a></li>
                    ...
                    <li>
                        ...
                        <ul>
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/statistique">
                              statistique
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/detail_users">
                              Enrolement
                            </a>
                          </li>
                          ...
                          <li>
                           ...
                           <li>
                            <a href="<?= base_url() ?>admin/evenement">
                                Evenement
                            </a>
                          ...
                          <li>
                            <a href="<?= base_url() ?>admin/paiement_apprenant">
                                Paiement apprenant
                            </a>
                          ...
                          <li>
                            <a href="<?= base_url() ?>admin/projet_plus">
                                Projet des apprenants
                            </a>
                          </li>

                          <li>
                            <a href="<?= base_url() ?>admin/view_formation">
                                Liste formation
                            </a>
                          </li>

                          <li>
                            <a href="<?= base_url() ?>admin/news_app">
                                Les nouvelles
                            </a>
                          </li>
                    ...
                    <li>
                        <a href="#uiComponents" class="has-arrow"><i class="icon-bag"></i><span>Opérations internes</span></a>
                        <ul>
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/formation">
                              Ajouter une formation
                            </a>
                          </li>
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/cours">
                              Ajouter un cours
                            </a>
                          </li>
                        
                          <li>
                            <a href="<?= base_url() ?>admin/section_cours">
                                Ajouter une section
                            </a>
                          </li>

                           <li>
                            <a href="<?= base_url() ?>admin/section_lesson">
                                Ajouter une leçon
                            </a>
                     ...
                     <li>
                        <a href="#uiComponents" class="has-arrow"><i class="icon-notebook"></i><span>Les gestionnaires</span></a>
                        <ul>
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/formateur">
                              Ajout Formateur
                            </a>
                          </li>

                          <li>
                            <a href="<?php echo(base_url()) ?>admin/membre">
                              Membres du groupes
                            </a>
                          </li>

                          <li>
                            <a href="<?php echo(base_url()) ?>admin/liste_membre">
                              Nos membres
                            </a>
                          </li>

                          <li>
                            <a href="<?php echo(base_url()) ?>admin/liste_incription">
                    ...
                    <li>
                        ...
                        <ul>
                          ...
                          <li>
                            <a href="<?php echo(base_url()) ?>admin/projet">
                              Les projets
                            </a>
                          </li>
                          ...
                          <li>
                           ...
                           <li>
                            <a href="<?php echo(base_url()) ?>admin/groupe">
                              Groupe de discution
                            </a>
                          </li>
